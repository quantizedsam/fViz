...
__name__    = 'fViz.ui.plotters.BasePlotter'
...
class BasePlotter():
    ...
    def __init__(self, plot_params, Axes):
        ...
        ----------
            ...
            Axes : dict
                Axes used for the plot as :class:`fViz.utils.axis.StaticAxis`.
        """
        ...
        assert type(_X) in _supported_axes or _X is None, 'Axes should either be lists, dicts or fViz.ui.axes.* or None'
        if _X is None:
            _X = {}
        ...
        assert type(_Y) in _supported_axes or _Y is None, 'Axes should either be lists, dicts or fViz.ui.axes.* or None'
        if _Y is None:
            _Y = {}
        ...
        assert type(_Z) in _supported_axes or _Z is None, 'Axes should either be lists, dicts or fViz.ui.axes.* or None'
        if _Z is None:
            _Z = {}
